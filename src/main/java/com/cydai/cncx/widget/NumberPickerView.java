...
public class NumberPickerView extends View {
    ...
    private static final int DEFAULT_TEXT_COLOR_NORMAL = 0XFF666666;

    // default text color of selected item
    private static final int DEFAULT_TEXT_COLOR_SELECTED = 0XFF666666;
    ...
    public void setValue(int value) {
        ...
        if (value > mMaxValue) {
            throw new IllegalArgumentException("should not set a value greater than mMaxValue, value is " + value + " max : " + mMaxValue);
        }
